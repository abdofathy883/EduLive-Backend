...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250721115624_HotLineFixes")]
    partial class HotLineFixes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.CertificateIssued", b =>
                {
                    ...
                    b.ToTable("CertificateIssueds");
                });

            modelBuilder.Entity("Core.Models.CertificateTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.GoogleMeetUserAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.LessonReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DiscussedValues")
                        .IsRequired()
                        .HasMaxLength(800)
                        .HasColumnType("nvarchar(800)");

                    b.Property<string>("ExplainedTopics")
                        .IsRequired()
                        .HasMaxLength(800)
                        .HasColumnType("nvarchar(800)");
                    ...
                    b.Property<string>("MemorizedContent")
                        .IsRequired()
                        .HasMaxLength(800)
                        .HasColumnType("nvarchar(800)");
            ...
            modelBuilder.Entity("Core.Models.WhatsappALert", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("WhatsappALert");
                });

            modelBuilder.Entity("Core.Models.ZoomMeeting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.ZoomUserAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Core.Models.CertificateIssued", b =>
                {
                    ...
                    b.HasOne("Core.Models.CertificateTemplate", "Template")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Models.GoogleMeetLesson", b =>
                {
                    b.HasOne("Core.Models.Lesson", "Lesson")
                        .WithOne("GoogleMeetLesson")
                        .HasForeignKey("Core.Models.GoogleMeetLesson", "LessonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Models.Message", b =>
                {
                    b.HasOne("Core.Models.BaseUser", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Models.BaseUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Models.ZoomMeeting", b =>
                {
                    b.HasOne("Core.Models.Lesson", "Lesson")
                        .WithOne("ZoomMeeting")
                        .HasForeignKey("Core.Models.ZoomMeeting", "LessonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
